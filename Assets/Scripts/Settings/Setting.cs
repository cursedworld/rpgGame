...
public class Setting : MonoBehaviour
{
    ...
    void Start() 
    {
        ...
        SensitivityS = GameObject.Find("Settings/Sensitivity/SensitivityChange").GetComponent<Slider>();
    ...
    public void ChangeQualitytext()
    {
        Debug.Log(QualitySettings.GetQualityLevel());
        switch (QualitySettings.GetQualityLevel())
        {
            case 0: Quality.text = "Ultra"; break;
            case 1: Quality.text = "Medium"; break;
